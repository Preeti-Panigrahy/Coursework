...
<html>
<head>
	<title>PizzaCorner - SignUp</title>
...
<div class="Loginwrapper">
    <div class="loginFormContainer">
        ...
        <div class="loginFormInner">
            <form action="/PizzaOrderWebsite2/connection/after_signup.php" method="POST" class="signup">
                <div class="field">
                ...
                <div class="signupLink">
                    Already a member? 
                    <a href="/PizzaOrderWebsite2/login.php">Login Here</a>
                </div>
            </form>
        </div>
    </div>
